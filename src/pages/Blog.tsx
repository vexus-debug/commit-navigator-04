    ...
    <div>
      <section className="relative py-20 bg-primary">
        <div className="container">
          <p className="text-secondary font-semibold text-sm uppercase tracking-wider mb-2">Eye Care Tips & News</p>
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-primary-foreground">APCARE Blog</h1>
          <p className="mt-4 text-primary-foreground/80 text-lg max-w-2xl">
            Updates, tips, and insights on eye health from the team at APCARE Eye Center.
          </p>
        </div>
      </section>
