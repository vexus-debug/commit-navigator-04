...
import {
  ...
  HomeGalleryEditor, HomeMissionSpotlightEditor, HomeSpotlightFeatureEditor,
...
import MediaLibrary from "./pages/admin/editors/MediaLibrary";
import InquiriesPage from "./pages/admin/editors/InquiriesPage";
import SeoManager from "./pages/admin/editors/SeoManager";
import ActivityLogPage from "./pages/admin/editors/ActivityLogPage";
import AnnouncementsEditor from "./pages/admin/editors/AnnouncementsEditor";
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/admin" element={<AdminGuard><AdminLayout /></AdminGuard>}>
                ...
                <Route path="home/mission-spotlight" element={<HomeMissionSpotlightEditor />} />
                <Route path="home/spotlight-feature" element={<HomeSpotlightFeatureEditor />} />
