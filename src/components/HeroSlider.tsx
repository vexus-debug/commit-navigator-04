    ...
    <section className="relative h-[75vh] md:h-[85vh] min-h-[480px] max-h-[800px] overflow-hidden">
      {slides.map((s, i) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[hsl(213,86%,6%,0.97)] via-[hsl(213,86%,10%,0.75)] to-[hsl(213,86%,10%,0.5)]" />
        </div>
      ))}
      ...
      <button
        onClick={prev}
        className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-xl bg-primary-foreground/[0.06] hover:bg-primary-foreground/15 backdrop-blur-xl border border-primary-foreground/10 flex items-center justify-center text-primary-foreground/60 hover:text-primary-foreground hover:shadow-glass-glow transition-all duration-300"
      ...
      <button
        onClick={next}
        className="absolute right-3 md:right-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 rounded-xl bg-primary-foreground/[0.06] hover:bg-primary-foreground/15 backdrop-blur-xl border border-primary-foreground/10 flex items-center justify-center text-primary-foreground/60 hover:text-primary-foreground hover:shadow-glass-glow transition-all duration-300"
